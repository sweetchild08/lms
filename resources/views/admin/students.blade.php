    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 p-4">
        <div class="m-4">
            ...
            <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800 pb-6">
              <form method="post" id="frmaddstudent">
                @csrf
                            ...
                            @forelse ($students as $student)
                                <tr class="bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-700 dark:text-gray-400">
                                    ...
                                    <div class="flex items-center text-sm">
                                        ...
                                        <div>
                                        <p class="font-semibold">{{$student->getFullName()}}</p>
                                    ...
                                    <div class="flex item-center justify-center">
                                      ...
                                      {{-- delete --}}
                                      <div data-studentid="{{$student->id}}" class="delstudent w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
$('#frmaddstudent').submit((e)=>{
  ...
  $('.delstudent').click(function(e){
    ...
    let url='{{route('admin.students.destroy',':id')}}'
