    ...
    <body>
        <div class="font-sans text-gray-900 antialiased">
            <div class="text-center mt-24">
                ...
                <span class="text-sm">or <a href="{{route('register','student')}}" class="text-blue-500"> 
                   sign up as student
                </a>
             </span>
          </div>
          <div class="flex justify-center my-2 mx-4 md:mx-0">
             <form class="w-full max-w-xl bg-white rounded-lg shadow-md p-6" action="{{route('register','teacher')}}" method="post">
                @csrf
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full md:w-full px-3 mb-6">
                     ...
                     <div class="w-full md:w-full px-3 mb-6">
                        <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for='last_name'>Title/Designation</label>
                        <input name="title" class="appearance-none block w-full bg-white text-gray-900 font-medium border border-gray-400 rounded-lg py-3 px-3 leading-tight focus:outline-none" type='title' value="{{old('title')}}"  id="title" autofocus>
                        @error('title')
                            <small class="text-red-500 mr-2">{{$message}}</small>
                        @enderror
                     </div>
